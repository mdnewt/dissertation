function [vertex,face,normal,quality] = read_ply(filename)
...
if any(strcmp('nx',fieldnames(d.vertex)))
    normal  = [d.vertex.nx, d.vertex.ny, d.vertex.nz];
else normal = [];
end
if any(strcmp('quality',fieldnames(d.vertex)))
    quality = d.vertex.quality;
else quality = [];
end
